...
@media (max-width: 767.98px) {
	...
	.expanded {
		max-height: none;
		/* Remove the height limit when expanded */
	}
	#readMoreBtn1 {
		display: block;
		color: #0d6efd;
				...
				<div class="col-lg-6" data-aos="fade-down">
					<div class="banner-imgs text-center">
						...
						<div class="view-all">
							...
							<!-- <a href="/" class="btn btn-view d-inline-flex align-items-center">Rezerva acum <span><i class="feather-arrow-right ms-2"></i></span></a> -->
						</div>
					</div>
				</div>
			</div>
...
<!-- Popular Services -->
<section class="section popular-services popular-explore pt-3">		
	<div class="container">	
		<!-- Heading title-->
							...
							<div class="listing-content">
								<div class="listing-features rental-car-item">												
									...
									<h3 class="listing-title">
										<a href="/inchirieri-masini.php"><?php echo $item['carName'];?></a>
									</h3>
								</div> 
								...
								<div class="listing-button">
									<?php if (Session::exists('step') && Session::get('step') > 1) { ?>
										<a onclick="rent_now(<?=$item['carID']?>)" class="btn btn-order"><span><i class="feather-calendar me-2"></i></span>Rezerva acum</a>
									<?php } else { ?>
										<a href="/inchirieri-masini.php" class="btn btn-order"><span><i class="feather-calendar me-2"></i></span>Rezerva acum</a>
									<?php } ?>
								</div>
							</div>
						</div>
...
<!-- Rental deals -->
<section class="section popular-services" style="padding-top: 10px">
	<div class="container">
		<div class="section-heading"  data-aos="fade-down">
			<h2>Recomandari!</h2>
		</div>
						...
						<div class="listing-item mb-0">										
							...
							<div class="listing-content">
								<div class="listing-features">												
									...
									<h3 class="listing-title">
										<a href="/inchirieri-masini.php"><?php echo $car['carName'];?></a>
									</h3>
								</div> 
								<div class="listing-details-group">
                                    <ul style="display: ruby-text">
...
<!-- 
<section class="section popular-services popular-explore pt-0 show-mobile-text" id="why-us-section">		
	<div class="container">	
		<div class="tab-content">
			<div class="tab-pane active why-content" id="Carmazda">	
				<div class="section-heading" data-aos="fade-down">
...
<script>
	...
	$(document).ready(function() {
		...
		$('#pickup_date').on('focus', function() {
			console.log('=======================')
			$(this).blur(); // Remove focus to prevent keyboard from opening
		});
		...
		$("#pickup_date").datetimepicker({
			...
			allowTimes:[
				...
				'13:00','13:30','14:30','15:00','15:30','16:00','16:30','17:00','17:30','18:00','18:30','19:00','19:30','20:00','20:30','21:00','21:30','22:00','22:30','23:00','23:00'
			],
			minDate: moment().startOf('day'),
		});
	...
	$(document).ready(function () {
		...
		var button2 = $('#readMoreBtn2');

		button2.click(function () {
			if (content2.hasClass('expanded')) {
				content2.removeClass('expanded');
				button2.text('Read More');
			} else {
				content2.addClass('expanded');
				button2.text('Read Less');
			}
		});
		var content3 = $('.content3');
		var button3 = $('#readMoreBtn3');

		button3.click(function () {
			if (content3.hasClass('expanded')) {
				content3.removeClass('expanded');
				button3.text('Read More');
			} else {
				content3.addClass('expanded');
				button3.text('Read Less');
			}
		});

		var content4 = $('.content4');
		var button4 = $('#readMoreBtn4');

		button4.click(function () {
			if (content4.hasClass('expanded')) {
				content4.removeClass('expanded');
				button4.text('Read More');
			} else {
				content4.addClass('expanded');
				button4.text('Read Less');
			}
		});
	});
