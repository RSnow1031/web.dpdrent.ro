                ...
                <div class="wizard">
                    <div class="wizard-inner">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation" class="active">
                                <!-- <div class="connecting-line"></div> -->
                                <a href="" data-toggle="tab" aria-controls="step2" role="tab" aria-expanded="false"><span class="round-tab">2</span> <i>Option</i></a>
                            </li>
                                                ...
                                                <div class="review-sec mt-0">
                                                    ...
                                                    <div class="booking-info service-tax">		
                                                        <ul>
                                                            ...
                                                            <li class="column-group-main">
                                                                <div class="input-block">
                                                                    <label>Dropoff Date: &nbsp;&nbsp;&nbsp;<?= $_SESSION['pickup_date'] . ' ' . $_SESSION['pickup_time']; ?></label>												
                                                                </div>
                                                            </li>
                                                            <li class="column-group-main">
                                                                <div class="input-block">
                                                            ...
                                                            <li class="column-group-main">
                                                                <div class="input-block">
                                                                    <label><?= $_SESSION['extra_content'];?>: &nbsp;&nbsp;&nbsp;&euro;<?= $_SESSION['extra_price'];?></label>												
                                                                </div>
                                                            </li>
                                                            <?php 
                                                        ...
                                                        <li class="column-group-main">
                                                            <div class="input-block">
                                                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                                                    <input type="text" name="casco" hidden value="<?= $_SESSION['casco'][1]?>">
                                                                    ...
                                                                    <?php if (intval($_SESSION['casco_price']) == 0) { 
                                                                        ...
                                                                        <label>Full casco (€<?= $_SESSION['casco'][1]?>/zi): &nbsp;&nbsp;&nbsp;<button class="btn btn-primary" type="submit">ADAUGA</button</label>	
                                                                    <?php } else { ?>
                                                                        <input type="text" name="casco_check" hidden value="2">
                                                                        <label>Full casco (€<?= $_SESSION['casco'][1]?>/zi): &nbsp;&nbsp;&nbsp;<button class="btn btn-danger" type="submit">STERGE</button</label>	
                                                                    <?php }?>
                                                                </form>											
                                                            </div>
                                                        </li>
